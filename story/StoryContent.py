        ...
        self.story = [
            discord.Embed(
                ...
                description="1 อาทิตย์ ก่อนโรคระบาดกระจาย ผู้คนบนเกาะยังดำเนินชีวิตไปอย่างปกติ ทุกคนต่างก็เป็นมิตรและพึ่งพาอาศัยซึ่งกันและกัน ทรัยากรต่าง ๆ"
                            "มีมากมาย อารยธรรมของมนุษยชาติยังคงดำเนินไปตามปกติที่ควรจะเป็น แต่ทว่าความสงบสุขเหล่านั้นใกล้จะถึงเวลาหมดไป",
                colour=discord.Colour.from_rgb(85, 226, 32)
            ),
            discord.Embed(
                title="📖 บทที่ 2 โรคระบาดครั้งใหญ่",
                description="อาทิตย์ที่ 2 หลังจากได้เตรียมตัว พร้อมรับการเปลี่ยนแปลงครั้งใหญ่ของเซิร์ฟ "
            ...
            discord.Embed(
                title="📖 บทที่ 3 โรคระบาดครั้งใหญ่",
